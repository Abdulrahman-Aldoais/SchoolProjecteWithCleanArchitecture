            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "75c515b1-00cf-4101-aa43-038fd1b0dc26",
                            Name = "Admin",
                            NormalizedName = "admin"
                        },
                        new
                        {
                            Id = "fdf90c33-2086-4967-85ab-d2e836204306",
                            Name = "Student",
            ...
            modelBuilder.Entity("School.Domain.Entities.Department", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DateCreated = new DateTime(2023, 11, 16, 16, 10, 18, 211, DateTimeKind.Local).AddTicks(8415),
                        ...
                        new
                        {
                            ...
                            CreatedBy = "75a6ff65-8b01-4981-9ca6-c550919d62b1",
                            DateCreated = new DateTime(2023, 11, 16, 16, 10, 18, 211, DateTimeKind.Local).AddTicks(8492),
                            Description = "Description",
                            Name = "IT"
                        },
                        new
                        {
                            ...
                            CreatedBy = "75a6ff65-8b01-4981-9ca6-c550919d62b1",
                            DateCreated = new DateTime(2023, 11, 16, 16, 10, 18, 211, DateTimeKind.Local).AddTicks(8521),
                            Description = "Description",
                            Name = "IS"
                        });
                });
            ...
            modelBuilder.Entity("School.Domain.Entities.Student", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Age = 19,
                            CreatedBy = "75a6ff65-8b01-4981-9ca6-c550919d62b1",
                            DateCreated = new DateTime(2023, 11, 16, 16, 10, 18, 213, DateTimeKind.Local).AddTicks(3567),
                        ...
                        new
                        {
                            ...
                            Age = 0,
                            CreatedBy = "75a6ff65-8b01-4981-9ca6-c550919d62b1",
                            DateCreated = new DateTime(2023, 11, 16, 16, 10, 18, 213, DateTimeKind.Local).AddTicks(3631),
                            DepartmentId = new Guid("75a6ff65-8b01-4981-9ca6-c550919d62b0"),
                            Name = "صلاح محمود على"
                        });
                });
